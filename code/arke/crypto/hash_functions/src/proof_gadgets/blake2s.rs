...
use crate::proof_gadgets::PRFGadget;
use ark_r1cs_std::prelude::*;

use ark_crypto_primitives::prf::Blake2s;
use core::borrow::Borrow;

pub fn blake2_as_crh_params(
    hash_length: u16,
    offset: u32,
...
pub fn evaluate_blake2s_with_parameters<F: PrimeField>(
    ...
    let mut h = vec![
        UInt32::constant(0x6A09E667).xor(&UInt32::constant(parameters[0]))?,
        UInt32::constant(0xBB67AE85).xor(&UInt32::constant(parameters[1]))?,
        UInt32::constant(0x3C6EF372).xor(&UInt32::constant(parameters[2]))?,
        UInt32::constant(0xA54FF53A).xor(&UInt32::constant(parameters[3]))?,
        UInt32::constant(0x510E527F).xor(&UInt32::constant(parameters[4]))?,
        UInt32::constant(0x9B05688C).xor(&UInt32::constant(parameters[5]))?,
        UInt32::constant(0x1F83D9AB).xor(&UInt32::constant(parameters[6]))?,
        UInt32::constant(0x5BE0CD19).xor(&UInt32::constant(parameters[7]))?,
    ];
...
#[cfg(test)]
mod test {
    use ark_crypto_primitives::prf::Blake2s as B2SPRF;
    ...
    use super::{evaluate_blake2s, Blake2sGadget};
    use ark_r1cs_std::prelude::*;
